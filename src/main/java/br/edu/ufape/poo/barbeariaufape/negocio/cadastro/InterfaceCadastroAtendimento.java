...
public interface InterfaceCadastroAtendimento {
    ...
    Atendimento cadastrarAtendimento(Barbeiro barbeiro, Servico servico, Produto produto, String pagamento, Cliente cliente);
    Atendimento atualizarAtendimento(Long id, Barbeiro barbeiro, Servico servico, Produto produto, String pagamento, Cliente cliente);
